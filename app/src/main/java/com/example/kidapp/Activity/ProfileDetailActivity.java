...
public class ProfileDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        optionsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ProfileDetailActivity.this, "Options clicked", Toast.LENGTH_SHORT).show();
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ProfileDetailActivity.this, "Edit profile clicked", Toast.LENGTH_SHORT).show();
        ...
        helpDeskOption.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ProfileDetailActivity.this, "Help Desk clicked", Toast.LENGTH_SHORT).show();
        ...
        logOutOption.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ProfileDetailActivity.this, "Log Out clicked", Toast.LENGTH_SHORT).show();
